...
function updateCanvas() {
    ...
    document.getElementById("to_be_drawn").innerHTML = "To be drawn : " + sketch;
}
...
function checkSketch() {
    ...
    if (timerCheck == "complete" || answer_holder == "set") {
        updateCanvas();
        timerCheck = "";
        answer_holder = "";
...
function gotResult(error, results) {
    if (error) {
        ...
        document.getElementById("sketch_label").innerHTML = "label : " + results[0].label;
